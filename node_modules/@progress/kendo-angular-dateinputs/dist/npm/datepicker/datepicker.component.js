...
var DatePickerComponent = /** @class */ (function () {
    ...
    Object.defineProperty(DatePickerComponent.prototype, "show", {
        ...
        set: function (show) {
            ...
            var skipZone = !show && (!this._show || !utils_1.hasObservers(this.close));
            if (!skipZone) {
    ...
    DatePickerComponent.prototype.handleFocus = function () {
        ...
        this.isActive = true;
        if (utils_1.hasObservers(this.onFocus)) {
            this.zone.run(function () {
                _this.onFocus.emit();
            });
        }
    ...
    DatePickerComponent.prototype.handleBlur = function (args) {
        ...
        if (utils_1.hasObservers(this.onBlur) || (this.show && utils_1.hasObservers(this.close)) || utils_1.requiresZoneOnBlur(this.control)) {
            this.zone.run(function () {
                _this.blurComponent();
            });
        }
