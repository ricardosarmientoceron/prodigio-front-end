...
var CalendarComponent = /** @class */ (function () {
    ...
    CalendarComponent.prototype.onPageChange = function () {
        ...
        if (!core_1.NgZone.isInAngularZone()) {
            ...
            this.pageChangeSubscription = fromPromise_1.fromPromise(this.resolvedPromise)
                .subscribe(function () {
                _this.detectChanges(); // requires zone if templates
            });
        }
    ...
    CalendarComponent.prototype.handleBlur = function (args) {
        var _this = this;
        this.isActive = false;
        if (utils_1.requiresZoneOnBlur(this.control)) {
            this.ngZone.run(function () {
    ...
    CalendarComponent.propDecorators = {
        ...
        'navigationItemTemplate': [{ type: core_1.Input }, { type: core_1.ContentChild, args: [navigation_item_template_directive_1.NavigationItemTemplateDirective,] },],
