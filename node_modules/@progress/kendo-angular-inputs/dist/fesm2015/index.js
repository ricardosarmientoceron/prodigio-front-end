...
class SliderComponent {
    ...
    setValueChangeInterval(element, callback) {
        this.ngZone.runOutsideAngular(() => {
            const mousedown = fromEvent$1(element, 'mousedown');
            const mouseup = fromEvent$1(element, 'mouseup');
            const mouseout = fromEvent$1(element, 'mouseout');
            const subscription = mousedown.pipe(filter$1((e) => e.button === 0 && !this.isDisabled), concatMap$1(() => interval$1(150).pipe(startWith$1(-1), takeUntil$1(merge$1(mouseup, mouseout))))).subscribe(() => {
                this.focus();
                callback();
            });
...
class TextAreaDirective {
    ...
    ngOnInit() {
        ...
        this.zone.runOutsideAngular(() => {
            ...
            this.inputSubscription = fromEvent$1(element, 'input')
...
class FloatingLabelInputAdapter {
    constructor(component, formControl) {
        ...
        const isObservableOrEventEmitter = (event) => event instanceof Observable$1 || event instanceof EventEmitter;
...
class TextBoxContainerComponent {
    ...
    ngAfterContentInit() {
        ...
        const control = new FloatingLabelInputAdapter(this.textbox || this.textarea || this.formControl.valueAccessor, this.formControl);
    ...
    updateState() {
        ...
        if (formControl) {
            ...
            const value = (this.textbox || this.textarea).value;
 ...
 * @hidden
 */
class KendoDraggableDirective {
    constructor(ngEl, ngZone) {
...
export { DraggableModule as ɵf, EventsModule as ɵg, MaskingService as ɵb, LocalizedMessagesDirective$2 as ɵk, Messages as ɵa, SliderCustomMessagesComponent as ɵc, LocalizedMessagesDirective as ɵe, Messages$1 as ɵd, SwitchCustomMessagesComponent as ɵh, LocalizedMessagesDirective$1 as ɵj, Messages$2 as ɵi, SliderComponent, LabelTemplateDirective, SwitchComponent, NumericTextBoxComponent, NumericTextBoxCustomMessagesComponent, MaskedTextBoxComponent, InputsModule, SliderModule, SwitchModule, NumericTextBoxModule, MaskedTextBoxModule, TextBoxContainerComponent, TextBoxDirective, TextAreaDirective, TextBoxModule, EventsOutsideAngularDirective, KendoDraggableDirective, SliderTicksComponent };
